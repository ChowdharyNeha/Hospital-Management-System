            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-tasks fa-3x"></i> Reports
                            </li>
                        </ol>
                    </div>
                </div>
									...
									<thead>
										<tr>
                                                                                               <script type="text/javascript">
                                                                                                    ...
                                                                                                    {
                                                                                                    var xmlhttp;
                                                                                                    var k=document.getElementById("patient_id").value;
                                                                                                    var urls="checkpatientname.jsp?ver="+k;
                                                                                                      ...
                                                                                                      if (xmlhttp.readyState==4)
                                                                                                        {
                                                                                                            ...
                                                                                                            //document.forms["login"]["username"].fname = xmlhttp.responseText;
                                                                                                         }
                                                                                                      }
                                                                                                    ...
                                                                                                    {
                                                                                                    var xmlhttp;
                                                                                                    var k=document.getElementById("doc_id").value;
                                                                                                    var urls="checkdoctorname.jsp?ver="+k;
                                                                                                    ...
                                                                                                    xmlhttp.onreadystatechange=function()
                                                                                                      ...
                                                                                                      if (xmlhttp.readyState==4)
                                                                                                        {
                                                                                                            //document.getElementById("err").innerHTML=xmlhttp.responseText;
                                                                                                            document.getElementById("doctorname").value=xmlhttp.responseText;
											...
											<td>Patient ID</td>
											<td><input type="text" name="patient_id" id="patient_id" onkeyup="getPatientData()"></td>
										</tr>
                                                                                <tr>
											<td>Doctor ID</td>
											<td><input type="text" name="doc_id" id="doc_id" onkeyup="getDoctorData()" ></td>
										</tr>
									</thead>
									<tbody>
										<tr>
										...
										<tr>
											<td>Doctor Name</td>
											<td><input type="text" name="doc_name" id="doctorname"></td>
				...
				<div id="editrecord" class="modal fade" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="editreports.jsp" method="post">
										...
										<tr>
											...
											<td>
												<select name="opt_change">
													...
													<option value="patientname" name="changeableopt">Patient Name</option>
													<option value="doctorname" name="changeableopt">Doctor Name</option>
													<option value="disease" name="changeableopt">Disease</option>
													<option value="fees" name="changeableopt">Fees</option>
													<option value="dosage" name="changeableopt">Dosage</option>
													<option value="medicine" name="changeableopt">Medicine </option>
				...
				<div id="deleterecord" class="modal fade" role="dialog">
					<div class="modal-dialog">
							...
							<div class="modal-body">
								<form action="deletereports.jsp" method="post">
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                 ...
                                 <div id="printrecord" class="modal fade" role="dialog">
					<div class="modal-dialog">
                                            <div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							...
							<div class="modal-body">
								<form action="printreports.jsp" method="post">
							...
							<div class="modal-footer">
								<input type="submit" class="btn btn-info" value="View Record">
								<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								</form>
							</div>
						</div>
...
while(rs.next())
{
	...
	String medicine = rs.getString(7);
	String prescription = rs.getString(8);
        String docId = rs.getString(9);
	%>
	<tr>
	<td><%=i%></td>
	<td><%=patientId%></td>
