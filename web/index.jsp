...
<html>
<head>
<title>HMS | Because Every Heart is Special ...</title>	
...
<div class="header">
	 ...
	 <div class="container">
				...
				<div class="top-header">
										<div class="logo">
						<a href="index.html"><h2 style="color:#00598e; text-decoration:None;">HOSPITAL MANAGEMENT SYSTEM</h2></a>
					</div>
					...
					<li><a href="mailto:info@example.com"><i> </i>info@example.com</a></li>
										...
										<ul style="list-style-type:None;" class="support">
											<li>
												<form action="checkadmin.jsp" method="post">
													<label style="color:D3D3DD">Username :</label> <input type="text" name="adminUname" />
													<label style="color:D3D3DD">Password :</label> <input type="password" name = "adminUpass" />
		 ...
		 <div class="content">
		      <div class="container">
				 <div class="content-grids">
					 <h2>A medicine or treatment that makes someone who is ill become healthy</h2>					 
					 <div class="col-md-4 contnt-grids">
						 <img src="images/w2.jpg" class="img-responsive" alt=""/>
						 <div class="caption2">
							 <h3><a href="#">Scientific & ideology</a></h3>							 
						 </div>
					 </div>
					 ...
					 <div class="col-md-4 contnt-grids">
						 ...
						 <div class="caption2">
							 <h3><a href="#">Health Care & Nutrition</a></h3>							 
						 </div>
					 </div>
					 <div class="clearfix"> </div>
				</div>
			 ...
			 <div class="project_grids">
				 ...
				 <div class="col-md-4 project3 fetur">
					 ...
					 <ul>
						 ...
						 <li class="last"><a href="#"><span>></span>Child Attivities</a></li>
				     </ul>
				 </div>
				 <div class="clearfix"> </div>
			 </div>
		  ...
		  <div class="footer">
			 <div class="container">				 	
				 ...
				 <div class="col-md-3 ftr-logo">
					 ...
					 <p>© 2015 Medicus. Design by <a href="http://w3layouts.com/">W3layouts</a></p>
				 </div>
				<div class="clearfix"></div>
			 </div>
		  </div>
