            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-wheelchair fa-3x"></i> Patient Details
                            </li>
                        </ol>
                    </div>
                </div>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="PatientDetailsServlet" method="post" enctype="multipart/form-data">
				...
				<div id="editrecord" class="modal fade" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="editpatientdetails.jsp" method="post">
										...
										<tr>
											...
											<td>
												<select name="opt_change">
													<option value="name" name="changeableopt">Patient name</option>
													<option value="age" name="changeableopt">Age</option>
													<option value="gender" name="changeableopt">Gender</option>
													<option value="address" name="changeableopt">Address</option>
				...
				<div id="deleterecord" class="modal fade" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="deletepatientdetails.jsp" method="post">
